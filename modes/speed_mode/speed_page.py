...
class Speed(Page):
    def __init__(self, parent: Frame, model: Model) -> None:
        ...
        self.current_icon = CTkLabel(self.current_frame, text="", image=BitmapImage(file="images/lightningBolt.xbm", foreground="yellow"))
        ...
        self.dcl_icon = CTkLabel(self.dcl_frame, text="", image=BitmapImage(file="images/limitIcon.xbm", foreground="yellow"))
        ...
        self.max_cell_label = CTkLabel(self.max_cell_value_frame, text="Max Cell", font=("Helvetica", 40), wraplength=self.width/4)
